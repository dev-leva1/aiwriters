...
const OPENROUTER_API_KEY = process.env.REACT_APP_OPENROUTER_API_KEY || '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'; // Замените на свой API ключ
